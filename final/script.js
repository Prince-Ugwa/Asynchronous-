...
//append it to the DOM element with the 'images' class, and resolve the promise. The fulfilled
// value should be the image element itself. In case there is an error loading the image ('error' event),
// reject the promise.
